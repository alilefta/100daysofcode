...
import com.alilefta.thrillio.constants.Gender;
...
public class DataStore {
	...
	/*
	 * Preferable to extract CONSTANTS and define them once.
	 */
	...
	private static void LoadMovies() {
		...
		bookmarks[1][4] = BookmarkManager.getInstance().createMovie(3004, "Ikiru", "", 1952, new String[] {"Takashi Shimura" ,"Minoru Chiaki"}, new String[] {"Akira Kurosawa"}, MovieGenre.FOREIEGN_MOVIES, 8.4);
	}
